...
def mix_up(a, b):
    ...
    if len(a) >= 2 and len(b) >= 2:
        ...
        return 'First or scond string without two chars'
...
if __name__ == '__main__':
    ...
    test(mix_up, ('kj', 'y'), 'First or scond string without two chars')
    test(mix_up, ('h', 'yt1'), 'First or scond string without two chars')
